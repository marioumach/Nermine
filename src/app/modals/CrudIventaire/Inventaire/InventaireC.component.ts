...
export class InventaireCComponent  {
  ...
  options1: string[] = ['patate', 'sel', 'escalope'];
  options2: string[] = ['légume', 'epice', 'volaille'];
  ...
  constructor(private _formBuilder: FormBuilder, public dialogRef: MatDialogRef<InventaireCComponent >,private shareService: ShareService) {}
